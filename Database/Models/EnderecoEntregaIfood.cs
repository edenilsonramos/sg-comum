...
{
    public class EnderecoEntregaIfood
    {
        [Browsable(false)]
    ...
    public class EnderecoEntregaIfoodEntityTypeConfiguration : IEntityTypeConfiguration<EnderecoEntregaIfood>
    {
        public void Configure(EntityTypeBuilder<EnderecoEntregaIfood> builder)
        {
            builder.ToTable("TENDERECOENTREGAIFOOD");
