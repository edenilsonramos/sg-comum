...
{
    public class PedidoStatusIfood
    {
        [Browsable(false)]
    ...
    public class PedidoStatusIfoodEntityTypeConfiguration : IEntityTypeConfiguration<PedidoStatusIfood>
    {
        public void Configure(EntityTypeBuilder<PedidoStatusIfood> builder)
        {
            builder.ToTable("TPEDIDOSTATUSIFOOD");
